            ...
            <Box className={classes.filter}>
              ...
              <Box className={classes.select}>
                ...
                <TextField
                  ...
                  label={filter.order !== null ? "" : "Giá"}
                  onChange={handleChangePrice}
                  InputLabelProps={{ shrink: false }}
                  value={filter.order}
                >
                  <MenuItem value="desc">Giá: Cao xuống thấp</MenuItem>
                  <MenuItem value="asc">Giá: Thấp lên cao</MenuItem>
                </TextField>
                <TextField
                  id="select2"
                  select
                  variant="outlined"
                  className={classes.textField}
                  label={filter.category !== null ? "" : "Danh mục"}
                  InputLabelProps={{ shrink: false }}
